...
vectorizer=TfidfVectorizer(use_idf=True,lowercase = True, analyzer='word', max_features = 50000,token_pattern='[^ ]+')
...
fh = open('one_lak_linear_total_prob.txt','w')  
fh.write('accident')
fh.write(' ')
fh.write('art')
fh.write(' ')
...
for i in range(0,len(predicted)):
	...
	fh.write("\n")
fh.close() 
fh = open('one_lak_linear_error_prob.txt','w')  
fh.write('accident')
fh.write(' ')
fh.write('art')
fh.write(' ')
